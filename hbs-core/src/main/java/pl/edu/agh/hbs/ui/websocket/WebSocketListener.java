package pl.edu.agh.hbs.ui.websocket;
...
import pl.edu.agh.hbs.exceptions.FrameSerializationException;
import pl.edu.agh.hbs.state.events.listeners.EventListener;
import pl.edu.agh.hbs.ui.WebClientConfigProvider;
import pl.edu.agh.hbs.ui.events.model.FramePreparedEvent;
import pl.edu.agh.hbs.ui.websocket.events.*;
...
public class WebSocketListener extends EventListener {
    ...
    public void onFramePrepared(FramePreparedEvent event) {
        try {
            ...
            throw new FrameSerializationException(e);
        }
    }
